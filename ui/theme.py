...
_DARK: dict[str, str] = {
    ...
    # LED page's serial log: drawn as inline HTML in a QTextEdit, so these
    # cannot come from the QSS and must be re-read on a theme change.
    "led-log-tx": "#7ec9ff",
    "led-log-rx": "#9fe39f",
    "led-log-error": "#ff8a80",
    "led-log-info": "#e8b339",
    "led-log-default": "#dcdcdc",
}
...
_LIGHT: dict[str, str] = {
    ...
    # Darkened rather than reused: the dark scheme's pastel log colours are
    # roughly 1.3:1 on a white QTextEdit, i.e. unreadable. These keep the
    # same tx/rx/error/info coding at printable contrast.
    "led-log-tx": "#0a58ca",
    "led-log-rx": "#1a7f37",
    "led-log-error": "#d1242f",
    "led-log-info": "#9a6700",
    "led-log-default": "#1f2733",
}
